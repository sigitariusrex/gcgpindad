...
// Public
$route['divisi/halaman/(:num)'] = 'divisi/index/$1';
$route['divisi/parameter/(:num)'] = 'parameter/index/$1';
...
// Dashboard
$route['dashboard/divisi/halaman/(:num)'] = 'dashboard/divisi/index/$1';
$route['dashboard/parameter/halaman/(:num)'] = 'dashboard/parameter/index/$1';
...
$route['admin/divisi/halaman/(:num)'] = "admin/divisi/index/$1";
$route['admin/divisi/ubah-status-verifikasi/(:num)'] = "admin/divisi/ubah_status_verifikasi/$1";
$route['admin/divisi/ubah-status-seleksi/(:num)'] = "admin/divisi/ubah_status_seleksi/$1";
$route['admin/divisi/ubah-status-pendaftaran/(:num)'] = "admin/divisi/ubah_status_pendaftaran/$1";
$route['admin/score/halaman/(:num)'] = "admin/score/index/$1";
$route['admin/parameter/halaman/(:num)'] = "admin/parameter/index/$1";
$route['admin/parameter-preview'] = 'admin/parameter/preview';
$route['admin/parameter-preview-error'] = 'admin/parameter/error';
$route['admin/parameter-cetak'] = 'admin/parameter/cetak';
$route['admin/parameter-cetak-error'] = 'admin/parameter/error';
