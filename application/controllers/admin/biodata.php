...
class Biodata extends Admin_Controller
{
    ...
    public function edit($id)
    {
        ...
        if ($this->biodata->simpan($biodata)) {
            $this->session->set_flashdata('pesan', 'Biodata berhasil disimpan. Kembali ke halaman ' . anchor('admin/divisi', 'divisi.', 'class="alert-link"'));
            redirect('admin/biodata/sukses');
        } else {
            $this->session->set_flashdata('pesan_error', 'Biodata berhasil disimpan. Kembali ke halaman ' . anchor('admin/divisi', 'divisi.', 'class="alert-link"'));
            redirect('admin/biodata/error');
        }
    }
