...
<div class="container">
    ...
    <div class="row navigasi_cari">
        ...
        <div class="col-xs-12 col-md-4 pull-right">
            <form method="get" action="<?php echo site_url('dashboard/parameter/cari');?>" role="form" class="form-horizontal">
        ...
        <div class="col-md-12">
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <?php foreach($parameter as $row): ?>
                    ...
                    $link_edit = anchor('dashboard/parameter/edit/'.$row->id, '<span class="glyphicon glyphicon-edit"></span>', array('title' => 'Edit'));
