    ...
    <div class="container">
        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <?php echo (isset($halaman) && $halaman == 'home') ? '<li class="active">' : '<li>'; ?> <?php echo anchor(site_url('dashboard'), '<span class="glyphicon glyphicon-home"></span> Home');?></li>
             ...
             <!-- Link Parameter -->
            <?php echo (isset($halaman) && $halaman == 'parameter') ? '<li class="active">' : '<li>'; ?> <?php echo anchor('dashboard/parameter', '<span class="glyphicon glyphicon-file"></span> Parameter'); ?></li>
        ...
        <!-- Informasi login -->
        <?php if (($login_status == true) && ($user_level == 'divisi')) : ?>
        <p class="navbar-text navbar-right">
            Login sebagai,
            <strong>
                <?php echo anchor('dashboard/logout',
                    '<span class="glyphicon glyphicon-user"></span> ' . $this->session->userdata('nama_divisi'),
