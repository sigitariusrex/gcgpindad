<div class="container" id="daftar-sukses">
    ...
    <div class="row">
        <div class="col-xs-4 col-md-2">No Divisi</div>
        <div class="col-xs-8 col-md-10">: <strong><?php echo $this->session->userdata('nomor_divisi'); ?></strong></div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-4 col-md-2">Nama Divisi</div>
        <div class="col-xs-8 col-md-10">: <strong><?php echo $this->session->userdata('nama_divisi'); ?></strong></div>
    </div>
    ...
    <div class="row">
     ...
     <div class="row">
        <div class="col-xs-4 col-md-2">Kode Divisi</div>
        <div class="col-xs-8 col-md-10">: <strong><?php echo $this->session->userdata('kode_divisi'); ?></strong></div>
    </div>
